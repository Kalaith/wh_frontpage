...
export const fetchQuests = async (
  filters: { class?: string; difficulty?: number } = {}
): Promise<Quest[]> => {
...
export const acceptQuest = async (
  ...
  const response = await fetch(
    `${API_BASE_URL}/quests/${encodeURIComponent(questRef)}/accept`,
    {
      method: 'POST',
      headers: authHeaders(),
...
export const submitQuest = async (
  ...
  const response = await fetch(
    `${API_BASE_URL}/quests/${encodeURIComponent(questRef)}/submit`,
    {
      method: 'POST',
      headers: authHeaders(),
...
export const cancelQuest = async (
  ...
  const response = await fetch(
    `${API_BASE_URL}/quests/${encodeURIComponent(questRef)}/cancel`,
    {
      method: 'POST',
      headers: authHeaders(),
    }
