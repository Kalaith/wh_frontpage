        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    Every achievement ever earned across all of Web Hatchery. Can you collect them all?
                </p>
            </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className={`text-xs font-bold uppercase px-1.5 py-0.5 rounded ${RARITY_TEXT[achievement.rarity]} bg-white/60`}>
                                        {achievement.rarity}
                                    </span>
                                </div>
            ...
            <div className="mt-6 text-center">
                <Link to="/quests" className="inline-block px-6 py-3 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700 transition shadow-lg">
