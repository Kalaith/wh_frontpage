...
const PortfolioPage: React.FC = () => {
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600">
          No contribution certificate available for this user.
        </p>
      </div>
    );
  }
  ...
  const levelPercent = Math.min(
    100,
    (adventurer.xp_total % (adventurer.level * 150)) / (adventurer.level * 1.5)
  );
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-indigo-50 border-2 border-indigo-200 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-slate-50 border-b border-gray-200 px-8 py-6 text-center text-slate-900">
          <div className="text-xs uppercase tracking-[0.3em] text-slate-500 mb-1 font-semibold">
            Web Hatchery
          </div>
        ...
        <div className="px-8 py-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            ...
            <div className="text-center bg-white rounded-xl p-4 shadow-sm border border-gray-100">
              <div className="text-3xl font-extrabold text-purple-600">
                {adventurer.xp_total.toLocaleString()}
              </div>
              <div className="text-xs text-gray-500 uppercase font-semibold mt-1">
                Total XP
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {adventurer.badges.map((badge, i) => (
                  <span
                    key={i}
                    className="bg-yellow-100 text-yellow-800 text-sm font-semibold px-3 py-1 rounded-full border border-yellow-200"
                  >
                    🏅 {badge.badge_name}
                  </span>
                ))}
          ...
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-400">
              Generated by Web Hatchery Gamification Engine •{' '}
