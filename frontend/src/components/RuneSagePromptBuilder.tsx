...
export const RuneSagePromptBuilder: React.FC<RuneSagePromptBuilderProps> = ({
  rsBrief,
  questTitle,
}) => {
  ...
  const buildPrompt = (): string => {
    ...
    if (rsBrief.suggested_prompt) {
      ...
      parts.push(
        `Please help me complete the quest "${questTitle}". Provide complete, working code.`
      );
    }
    parts.push('');
    parts.push(
      'Return ONLY the complete code. Do not include explanations unless asked.'
    );
    return parts.join('\n');
  };
