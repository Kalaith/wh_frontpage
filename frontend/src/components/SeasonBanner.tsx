            ...
            <div className="relative p-5 sm:p-6 lg:p-8 flex flex-col items-center justify-center gap-5">
                <div className="w-full text-center">
                    ...
                    <div className="flex flex-col gap-2">
                        <Link to="/quests" className="w-full text-center py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition shadow-sm">
                            🔮 View Quests
                        </Link>
                        <Link to="/leaderboard" className="w-full text-center py-2 bg-white text-slate-700 font-medium rounded-lg hover:bg-slate-50 transition border border-gray-200 shadow-sm">
                            🏆 Leaderboard
                        </Link>
                        <Link to="/bosses" className="w-full text-center py-2 bg-rose-50 text-rose-700 font-medium rounded-lg hover:bg-rose-100 transition border border-rose-200">
                            ⚔️ Boss Battle
                        </Link>
                    </div>
                </div>
                    ...
                    {isAuthenticated && adventurer ? (
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                <Link to={`/adventurers/${adventurer.github_username}`} className="font-bold text-lg text-slate-900 hover:text-indigo-600 transition">
                        ...
                        <div className="text-center py-2">
                            <p className="font-bold mb-1 text-slate-800">Not an Adventurer?</p>
                            <p className="text-sm text-slate-500 mb-3">Login to track your progress!</p>
                            {!isAuthenticated && (
                                <Link to="/login" className="block w-full py-2 bg-indigo-600 text-white hover:bg-indigo-700 rounded-lg text-sm font-medium transition shadow-sm">
                                    Login / Register
                                </Link>
                            )}
