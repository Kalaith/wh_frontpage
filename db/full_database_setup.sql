...
(9, 'Writers Studio', 'apps/writers_studio/', 'Creative writing studio for drafting, organizing, and refining long-form stories.', 'Tool', 'MVP', '1.0.0', 'apps', NULL, NULL, FALSE, NOW(), NOW()),
